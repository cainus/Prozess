...
Consumer.prototype.sendConsumeRequest = function(cb){  // TODO get rid of offset param
  ...
  this.onFetch(cb);
  var that = this;
  console.log("about to send a fetch request with offset: ", this.offset);// TODO should be this.offset
  var request = this.protocol.encodeFetchRequest( this.offset );  // TODO should be this.offset
